...
DepartureRow::DepartureRow(size_t displayWidth)
    : text(std::make_shared<ScrollingTextRow>(
          std::make_shared<TextRow>(
              std::vector<std::shared_ptr<RenderableText>>{std::make_shared<Text>("00:00", Color{168, 130, 221}),
                                                           std::make_shared<Text>(" ", Color{255, 255, 255}),
                                                           std::make_shared<Text>("Station", Color{224, 141, 121}),
                                                           std::make_shared<Text>(" ", Color{255, 255, 255}),
                                                           std::make_shared<Text>("14", Color{179, 242, 221})},
              CENTRE),
          50, displayWidth)) {}
