...
public:
  MqttDevice(PubSubClient* initClient, const std::vector<BaseMqttEntity*> entities,
             const char* deviceId, const char* name, const char* originName, const char* swVersion,
             const char* supportUrl, const char* initDiscoveryPrefix);
