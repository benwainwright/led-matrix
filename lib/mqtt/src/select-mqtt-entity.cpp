...
SelectMqttEntity::SelectMqttEntity(PubSubClient* client, const char* uniqueId,
                                   const char* friendlyName, const char* discoveryPrefix,
                                   const char* deviceClass, const std::vector<const char*> options,
...
JsonDocument SelectMqttEntity::config() const { return entity.config(); }

void SelectMqttEntity::initialise() { entity.initialise(); }

void SelectMqttEntity::setState(const String& state) { entity.setState(state); }

String SelectMqttEntity::id() const { return entity.id(); }

String SelectMqttEntity::state() { return entity.state(); }
