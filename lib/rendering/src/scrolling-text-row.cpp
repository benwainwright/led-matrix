...
bool ScrollingTextRow::isDirty() const
{
    return dirtyFromScroll || parent->isDirty();
}

int16_t ScrollingTextRow::getRenderedWidth()
{
    return parent->getRenderedWidth();
}

void ScrollingTextRow::setX(int16_t x)
{
    parent->setX(x);
}
...
void ScrollingTextRow::markRendered()
{
    dirtyFromScroll = false;
}

void ScrollingTextRow::setY(int16_t y)
{
    parent->setY(y);
}
...
int16_t ScrollingTextRow::y()
{
    return parent->y();
}

Text &ScrollingTextRow::operator[](size_t index)
{
    return (*parent)[index];
}

String ScrollingTextRow::rowString() const
{
    return parent->rowString();
}

size_t ScrollingTextRow::fontSize()
{
